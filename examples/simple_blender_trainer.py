...
class Config:
    ...
    # Dataset type
    dataset_type: Literal["colmap", "transforms", "blender"] = "blender"
    ...
    init_type: Literal["sfm", "random"] = "sfm" #sfm
...
class Runner:
    ...
    def __init__(self, cfg: Config) -> None:
        ...
        if cfg.dataset_type == "blender":
            self.parser = BlenderParser(data_dir=cfg.data_dir,factor=cfg.data_factor, normalize=False)
